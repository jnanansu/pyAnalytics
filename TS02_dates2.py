...
datetime(year=2020, month = 9, day = 18) # 8 and 9 gives error if used as 08 and 09 in datetime module

print(datetime.today()) #todays date
print(datetime.now())
...
pd.date_range('2017-08-16',periods=12) # default freq = 'D'
...
pd.date_range('2017-07-16',periods=6, freq='JAN')
pd.date_range('2017-01-01',periods=4, freq='Q-JAN') # Each quarter starting from january end
